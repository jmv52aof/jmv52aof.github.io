...
export const useApi = () => {
	...
	const getStationsFromApi = async (
		...
		const response = await getStations({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		if (response.data)
	...
	const getStationByIdFromApi = async (
		...
		const response = await getStationById({ ...options, token: sessionStorage.getItem('user-jwt-token') })
	...
	const getChargingSessionsFromApi = async (
		...
		const response = await getChargingSessions({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		if (response.data)
	...
	const stopChargingSessionFromApi = async (
		...
		const response = await stopChargingSession({ ...options, token: sessionStorage.getItem('user-jwt-token') })
	...
	const getRfidCardFromApi = async (
		...
		const response = await getRfidCard({ ...options, token: sessionStorage.getItem('user-jwt-token') })
	...
	const attachRfidCardFromApi = async (
		...
		const response = await attachRfidCard({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		return response.error
	}
	...
	const detachRfidCardFromApi = async (
		...
		const response = await detachRfidCard({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		return response.error
	}
	...
	const createPaymentMethodFromApi = async (
		...
		const response = await createPaymentMethod({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		return response.error
	}
	...
	const getPaymentMethodFromApi = async (
		...
		const response = await getPaymentMethod({ ...options, token: sessionStorage.getItem('user-jwt-token') })
	...
	const getPaymentUrlFromApi = async (
		...
		const response = await getPaymentUrl({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		if (undefined !== response.data) return response.data
		return undefined
	}
	...
	const deletePaymentMethodFromApi = async (
		...
		const response = await deletePaymentMethod({ ...options, token: sessionStorage.getItem('user-jwt-token') })
		return response.error
	}
