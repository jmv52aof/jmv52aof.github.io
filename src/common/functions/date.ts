 ...
 */
export const timeToISOString = (hours: number, minutes: number, seconds: number): string => {
 ...
 */
export const timeToStringWithUnitsOfMeasurement = (hours: number, minutes: number, seconds: number): string => {
 ...
 */
export const getTimesDifference = (reduced: Timestamp, subtracted: Timestamp): Timestamp  => {
    const reducedTime = timeToDate(reduced).getTime()
    const subtractedTime = timeToDate(subtracted).getTime()
    return dateToTimestamp(new Date(reducedTime <  subtractedTime
