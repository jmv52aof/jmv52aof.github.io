        ...
        <div className={styles.stationFilters}>
            <ContentBlockLayout>
                <div className={styles.stationFilters__onlyAvailable}>
                    ...
                    <Switch onChange={handleSwitchChange} enabled={stationFilters.onlyAvailableStations} />
                </div>
            </ContentBlockLayout>
            ...
            <div className={styles.stationFilters__footer}>
                ...
                />
                <Button onClick={applyFilters} variant="fill" text="Применить" disabled={!stationFilters.isModified} />
            </div>
        </div>
    );
}